...
//    require base_path('routes/category.php');
    ...
    Route::middleware(['ticket:admin'], 'auth')->group(function () {
...
Route::middleware(['user', 'auth'])->prefix('user')->group(function () {
    //Store Reservation
    Route::get('/dashboard', [ReservationController::class, 'UserDashboard'])->name('user.auth.dashboard');
    Route::get('/dashboard/profile', [ReservationController::class, 'UserProfile'])->name('auth.user.dashboard.profile');
    Route::get('/dashboard/your-ticket', [ReservationController::class, 'UserTicket'])->name('auth.user.dashboard.ticket');
    Route::get('/user/profile', [ReservationController::class, 'userProfile'])->name('user.dashboard.profile');
    Route::get('/user/profile/delete/{id}', [ReservationController::class, 'dltReservation'])->name('dlt.user.reservation');
