...
class SslCommerzPaymentController extends Controller
{
    ...
    public function payViaAjax(Request $request)
    {
        ...
        $requestData = json_decode($request->post('cart_json'));
        $post_data = array();
        ...
        # CUSTOMER INFORMATION
        $post_data['cus_name'] = 'Customer Name';
        $post_data['user_id'] = $requestData->cus_id;
    ...
    public function success(Request $request)
    {
        ...
        $paymentMethod = $request->input('card_issuer');
        ...
        $order_details = DB::table('orders')
            ...
            ->where('orders.transaction_id', $tran_id)
            ->select(
                'orders.*',
                'users.id as user_id',
                'users.name',
...
//            echo "Invalid Transaction";
            return view('frontend.payment_faild');
        }
