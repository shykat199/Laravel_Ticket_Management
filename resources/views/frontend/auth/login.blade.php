...
@section('auth.content')
    ...
    <div class="card-body p-4">
        <div class="text-center w-75 m-auto">
            ...
            <p class="text-muted mb-4">Enter your email address and password to place your reservation.</p>
        </div>
    ...
    <div class="row mt-3">
        <div class="col-12 text-center">
            <p class="text-muted">Don't have an account? <a href="{{route('user.registerPage')}}"
