    ...
    <section class="result-header-hero">
        <div class="container ticket-booking-home-header-hero-container">
            <div class="row gy-4 ticket-booking-home-header-hero-content">
                <div class="col-12 ticket-booking-home-header-search-ticket-form d-flex flex-column justify-content-end">
                    <form class="row g-3 pt-3 pb-5 px-2" action="{{ route('frontend.show.result') }}" method="post">
                        ...
                        <div class="col-md-5 col-xl-2 d-flex align-items-end hero-input-with-icon">
                            <input name="arrival_point"
                                ...
                                type="text" class="form-control" id="inputtext2" placeholder="To">
                            <i class="fa fa-map-marker"></i>
                        </div>
                        ...
                        <div class="col-md-3 col-xl-2 hero-input-with-icon mt-4">
                            ...
                            <input name="dateOfJourney"
                                ...
                                type="datetime-local" min="{{ $min_date->format('Y-m-d\TH:i:s') }}"
                                max="{{ $max_date->format('Y-m-d\TH:i:s') }}" class="form-control" id="inputtext3"
                        ...
                        <div class="col-md-3 col-xl-2 d-flex align-items-end hero-input-with-icon mt-4">
                            <input name="returnOfDate"
                                ...
                                type="datetime-local" min="{{ $min_date->format('Y-m-d\TH:i:s') }}"
                                max="{{ $max_date->format('Y-m-d\TH:i:s') }}" class="form-control" id="inputtext4"
                                placeholder="One Way">
                        ...
                        <div class="col-md-3 col-xl-2 hero-input-with-icon mt-4 hide-numberType-icon">
                            ...
                            <input name="totalPerson"
                                ...
                                type="number" class="form-control" id="inputtext5" placeholder="1 Adult">
                        ...
                        <div
                            ...
                            <input name="totalKids"
                                ...
                                type="number" class="form-control" id="inputtext4" placeholder="0 Kids">
        ...
        <section class="all-processing mt-5">
            <div class="container  pt-5">
                <div class="row g-5">
                                        ...
                                        <div class="">
                                            ...
                                            <div class="pt-4">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    ...
                                                    <p class="small text-light  mb-0">
                                                        {{ isset($busDetails->busDetails->bus_coach) ? $busDetails->busDetails->bus_coach : '' }}
                                                    </p>
                                                </div>
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <p class="small-text text-gray mb-0">Company</p>
                                                    <p class="small text-light  mb-0">
                                                        {{ isset($busDetails->busDetails->busCompany->bus_company) ? $busDetails->busDetails->busCompany->bus_company : '' }}
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="mt-4 d-flex align-items-center justify-content-between">
                                                <div class="">
                                                    ...
                                                    <p class="small-text text-light mb-0">
                                                        {{ isset($sessionData['dateOfJourney']) ? $sessionData['dateOfJourney'] : '' }}
                                                    </p>
                                                </div>
                                            ...
                                            <div class="pt-4">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <p class="small text-light mb-0">
                                                        {{ isset($sessionData['starting_point']) ? $sessionData['starting_point'] : '' }}
                                                    </p>
                                                    <p class="small text-light  mb-0">
                                                        {{ isset($sessionData['arrival_point']) ? $sessionData['arrival_point'] : '' }}
                                                    </p>
                                                </div>
                                        ...
                                        <div class="">
                                            ...
                                            <div class="pt-4">
                                                ...
                                                @if (isset($sessionData['totalKids']))
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <p class="small-text text-gray mb-0">
                                                            {{ isset($sessionData['totalKids']) ? $sessionData['totalKids'] : '' }}
                                                            Children</p>
                                                        <p class="small text-light  mb-0">
                                                            ${{ isset($busDetails->ticket_price) && isset($sessionData['totalKids']) ? $busDetails->ticket_price * $sessionData['totalKids'] : '' }}
                                                        </p>
                                                    </div>
                                                @endif
                                                ...
                                                <div class="d-flex align-items-center justify-content-between text-danger">
                                                    ...
                                                    <h5>
                                                        ${{ isset($busDetails->ticket_price) && isset($sessionData['totalPerson']) && isset($sessionData['totalKids'])
                                                            ? $busDetails->ticket_price * $sessionData['totalPerson'] + $busDetails->ticket_price * $sessionData['totalKids']
                                                            : '' }}
                                                    </h5>
                                                </div>
                                            </div>
                    ...
                    <form class="col-md-8 order-1 order-md-2  personal-form-container"
                        action="{{ route('frontend.ticket.store.payment-details') }}" method="post">
                        @csrf
                        <div id="allData">
                            <div class="row personal-form-content shadow-sm">
                                ...
                                <div class="collapse show personal-form" id="collapseExample">
                                    ...
                                    <div
                                        class="row border border-bottom-0 border-secondary-subtle rounded-0  all-ticket-card-left py-3">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4 personal-form-input-with-icon">
                                            ...
                                            <input type="text" name="dob" class="form-control" id="birth-date"
                                                placeholder="">
                                        ...
                                        <div class="col-md-3 col-lg-2 pt-4 d-flex align-items-center">
                                        ...
                                        <div class="col-md-3 col-lg-2 d-flex align-items-center pt-4">
                                ...
                                <div class="collapse show personal-form" id="collapseExample">
                                    ...
                                    <div
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" name="c_vvv" class="form-control"
                                                id="CardHolderName" placeholder="Cvv">
                                        </div>
                                    </div>
                                </div>
                            </div>
