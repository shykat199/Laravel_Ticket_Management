...
@section('admin.content')
    ...
    <form action="{{route('blog.store')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-floating mb-3">
            <input type="text" name="post_title" class="form-control" id="floatingInput" placeholder="Post Title"/>
        ...
        <textarea class="ckeditor form-control" name="post_description"></textarea>
