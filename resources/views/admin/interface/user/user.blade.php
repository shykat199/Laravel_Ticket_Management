...
@section('admin.content')
    ...
    <div class="mb-2">
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#centermodal">Add New
            User &nbsp; &nbsp; <i class="fa-solid fa-circle-plus"></i></button>
    </div>
